  ...
  return (
    <div className="rounded border border-glass-border bg-surface-elevated/50 p-3">
      <div className="flex items-center gap-2 mb-1">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-neon-green shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {copied ? (
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-neon-green">
